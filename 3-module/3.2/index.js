...
(function () {
    ...
    document.addEventListener('mousemove', function (event) {
        if (movingElement) {
            ...
            /*movingElement.style.right = (parseInt(movingElement.style.left + movingElement.offsetWidth  || 0, 10) + deltaX) + 'px';
            movingElement.style.bottom = (parseInt(movingElement.style.top + movingElement.offsetWidth || 0, 10) + deltaY) + 'px';*/
